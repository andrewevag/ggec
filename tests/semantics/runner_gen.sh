...
syntaxGenScriptPath=f'/home/andreas/Projects/EdsgerProgramGenerator/gen.sh' if os.getenv('PROGRAMGENPATH')==None else f'{os.getenv("PROGRAMGENPATH")}/gen.sh'
progsdir = f'/home/andreas/Projects/EdsgerProgramGenerator' if os.getenv('PROGRAMGENPATH')==None else f'{os.getenv("PROGRAMGENPATH")}'
